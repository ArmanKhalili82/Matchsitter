  ...
  addUtilities([
    {
      ...
      '.typo-mob-button-lg': { fontSize: '16px', fontWeight: '600', lineHeight: '1.5' },
      '.typo-desk-button-md': { fontSize: '18px', fontWeight: '600', lineHeight: '1.5' },
      '.typo-mob-button-md': { fontSize: '16px', fontWeight: '600', lineHeight: '1.5' },
